...
class Project_markdown_writer implements IProject_export_writer
{
	...
	private function construct_provenance_message(Metadata_provenance $provenance): string
	{
		...
		$markdown_provenance_message = "### " . Metadata_provenance::TITLE . $markdown_divider . Metadata_provenance::GENERATED_FROM_TEXT . "\n\n"
			. "Generated on (New Zealand time): " . $provenance->generated_on_new_zealand_time . "\n\n"
			. "Generated on (UTC): " . $provenance->generated_on_utc . "\n\n"
